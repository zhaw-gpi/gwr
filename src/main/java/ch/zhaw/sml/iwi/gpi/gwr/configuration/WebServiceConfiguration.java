...
import ch.zhaw.sml.iwi.gpi.gwr.endpoint.GebaeudeUndWohnungsregisterService;
...
public class WebServiceConfiguration {    
     ...
     */
    @Bean
    public GebaeudeUndWohnungsregisterService gebaeudeUndWohnungsregisterService() {
        return new GebaeudeUndWohnungsregisterService();
    }
     ...
     * weiter definiert (GebaeudeUndWohnungsregisterService).
     * 
    ...
    public Endpoint jaxwsEndpoint() {
        ...
        // http://localhost:PORT/soap/ResidentRegisterService auf den Webservice
        // zugegriffen werden
