 ...
 * Gebäudesuche mit den Adressangaben
 Es wird in der Register-Datenbank eine Abfrage auf die Entity BuildingEntity platziert, 
...
public class GetBuildingFromGwrDbDelegate implements JavaDelegate{
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        List<BuildingEntity> gefundeneGebaeude = gebaeudeRepository.findByAddressAttributes(dplz4, strname, deinr);
